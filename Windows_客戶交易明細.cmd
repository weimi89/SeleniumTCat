...
if %errorlevel%==0 (
    ...
    wt -w 0 -p "PowerShell" pwsh -NoExit -ExecutionPolicy Bypass -WorkingDirectory "%CD%" -File "scripts\customer_transactions.ps1" %*
    goto :end
)
...
if %errorlevel%==0 (
    ...
    start "" pwsh -NoExit -ExecutionPolicy Bypass -WorkingDirectory "%CD%" -File "scripts\customer_transactions.ps1" %*
    goto :end
)
