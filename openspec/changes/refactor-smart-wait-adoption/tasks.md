...
## 4. FreightScraper 優化（Phase 3）

### 4.1 替換導航間隔
- [ ] 4.1.1 **修改** `freight_scraper.py:74` - 優化導航邏輯
- [ ] 4.1.2 **測試** - 執行運費查詢下載（單一日期範圍）
- [ ] 4.1.3 **驗證** - 確認導航成功

### 4.2 替換直接 URL 等待
- [ ] 4.2.1 **修改** `freight_scraper.py:178, 188` - 替換為智慧等待
- [ ] 4.2.2 **測試** - 執行運費查詢下載（完整）
- [ ] 4.2.3 **驗證** - 確認 AJAX 搜尋和下載正常
- [ ] 4.2.4 **Commit** - `git commit -m "重構: FreightScraper 採用智慧等待"`
...
## 5. UnpaidScraper 優化（Phase 4）

### 5.1 替換導航間隔
- [ ] 5.1.1 **修改** `unpaid_scraper.py:54` - 優化導航邏輯
- [ ] 5.1.2 **測試** - 執行交易明細表下載（1 週期）
- [ ] 5.1.3 **驗證** - 確認導航成功

### 5.2 替換 alert 等待
- [ ] 5.2.1 **修改** `unpaid_scraper.py:158` - 改善 alert 檢測
- [ ] 5.2.2 **測試** - 執行交易明細表下載
- [ ] 5.2.3 **驗證** - 確認 alert 處理正常

### 5.3 替換 AJAX 等待
- [ ] 5.3.1 **修改** `unpaid_scraper.py:195, 211` - 替換為 `smart_wait_for_ajax()`
- [ ] 5.3.2 **測試** - 執行交易明細表下載（2 週期）
- [ ] 5.3.3 **驗證** - 確認多週期處理正常
- [ ] 5.3.4 **Commit** - `git commit -m "重構: UnpaidScraper 採用智慧等待"`

### 5.4 完整功能驗證
- [ ] 5.4.1 **測試** - 執行完整交易明細表下載
- [ ] 5.4.2 **驗證** - 檢查所有週期檔案正確
